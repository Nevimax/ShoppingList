...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView() {
        with(recyclerView_shopList) {
            shopListAdapter = ShopListAdapter()
            recyclerView_shopList.adapter = shopListAdapter
            recyclerView_shopList.recycledViewPool.setMaxRecycledViews(
    ...
    private fun setupSwipeListener() {
        ...
        itemTouchHelper.attachToRecyclerView(recyclerView_shopList)
    }
